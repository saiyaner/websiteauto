    ...
    <header
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link to="/sign-in">
            <button className="text-sm font-bold hover:text-primary transition-colors">Login</button>
          </Link>
          <Link to="/sign-up">
            <button className="bg-primary hover:bg-primary/90 text-white text-sm font-bold px-6 py-2.5 rounded-lg transition-all shadow-lg shadow-primary/20">
              Sign Up
            </button>
          </Link>
        </div>
