export default function DashboardAdmin() {
    return (
        <main className="flex-1 flex flex-col h-screen overflow-y-auto bg-slate-50 dark:bg-background-dark/50">
            <header className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 px-4 md:px-8 py-4 bg-white dark:bg-background-dark sticky top-0 z-30">
                <div className="flex items-center gap-4 lg:hidden">
                    <label className="p-2 -ml-2 text-slate-600 dark:text-slate-300 cursor-pointer" htmlFor="mobile-menu-checkbox">
            ...
            <footer className ="mt-auto border-t border-slate-200 dark:border-slate-800 px-4 md:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4 text-slate-500 text-[10px] md:text-xs text-center md:text-left">
                <p>© 2024 Marketplace Pro. All rights reserved.</p>
                <div className ="flex items-center gap-6">
                    <a className ="hover:text-primary transition-colors py-1" href="#">Privacy Policy</a>
                    <a className ="hover:text-primary transition-colors py-1" href="#">Terms of Service</a>
                </div>
            </footer>
        </main>
    );
